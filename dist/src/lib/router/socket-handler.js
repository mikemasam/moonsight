...
const addISocketRoute = (stat, isocket) => __awaiter(void 0, void 0, void 0, function* () {
    if (!isocket)
        return false;
...
const queueEndpoint = (endpoint, handler, middlewares) => __awaiter(void 0, void 0, void 0, function* () {
...
const addISocketMount = (stat, isocketmount) => __awaiter(void 0, void 0, void 0, function* () {
    const originalUrl = yield cleanRoutePath(stat.location);
