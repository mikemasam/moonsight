...
export type iSocketHandler = (req: SocketRequest, res: SocketResponse, appState: AppState) => Promise<AppResponse | void>;
export type iRouteHandler = (req: HttpRequest, res: HttpResponse, appState: AppState) => Promise<AppResponse | void>;
export type CoreRouteHandler = (req: SocketRequest, res: SocketResponse, appState: AppState) => Promise<AppResponse | void>;
export type ISocketMountRouteHandler = (req: SocketRequest, appState: AppState) => Promise<void>;
export type IHttpMiddlewareHandler = (appState: AppState, req: HttpRequest, res: HttpResponse, args: any, callback: (hook: (data: any, status: ResponseStatus) => any) => void) => Promise<AppResponse | void>;
export type ISocketMiddlewareHandler = (appState: AppState, req: HttpRequest | SocketRequest, res: HttpResponse | SocketResponse, args: any, callback: (hook: (data: any, status: ResponseStatus) => any) => void) => Promise<AppResponse | void>;
