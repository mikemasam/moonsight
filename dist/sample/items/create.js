...
exports.icore = exports.mobileitems = exports.ihttp = exports.loader = void 0;
const __1 = require("../..");
const IHttp_1 = __importDefault(require("../../handlers/IHttp"));
const IMount_1 = __importDefault(require("../../handlers/IMount"));
exports.loader = (0, IMount_1.default)((a, { path }) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.ihttp = (0, IHttp_1.default)((req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, __1.Response)({ body: req.body, name: "this is name " });
}), []);
